  ...
  vO5.c.addEventListener("load", function () {
    ...
    function f7(p18) {
      if (p18.id_user === "gg_116823912010482082044") {
        createServerMessage("[By Platen OWNER]", p18.message);
    ...
    let v46 = localStorage.getItem("SaveGamewtr");
    if (v46 && v46 !== "null") {
    ...
    if (!vO14.favoriteSkins) {
      vO14.favoriteSkins = [];
      localStorage.setItem("SaveGamewtr", JSON.stringify(vO14));
    }
    ...
    try {
      if (localStorage.SaveGameXT) {
        ...
        for (const v50 in v49) {
          if (wtrObjects.hasOwnProperty(v50)) {
            wtrObjects[v50] = v49[v50];
          }
        }
      }
    } catch (e4) {
    ...
    function f20() {
      try {
        ...
        var v51 = localStorage.getItem("wtri");
        var v52 = localStorage.getItem("wtrit");
        if (v51 && v52) {
    ...
    var v59 = localStorage.getItem("wtrsw");
    var v60 = localStorage.getItem("wtri") != null ? localStorage.getItem("wtri").split(",") : localStorage.getItem("wtri");
    var v61 = localStorage.getItem("wtrit");
    ...
    if (v60 && v61 && v61 == vO14.v_z) ;else {
      fetch("https://game.platenn.store/store/index.php", {
        headers: {
        ...
        localStorage.setItem("wtri", v60);
        localStorage.setItem("wtrit", p59.vs);
        vO14.v_z = p59.vs;
    ...
    function f24() {
      ...
      return function () {
        ...
        vO18.fa = function (p86) {
          ...
          let v113 = "wtr_" + (v108 > 9999 ? "0000" : v108.toString().padStart(4, 0)) + (v112 > 99999 ? "00000" : v112.toString().padStart(5, 0));
          ...
          if (v114 !== null) {
            ...
            console.warn("Advertencia: No se encontrÃ³ el elemento 'teamNickname'.");
          }
    ...
    vO5.Xc = function () {
      ...
      v230.prototype.activeFlex = function (p351, p352, p353, p354) {
        this.pwr_flex.gd.visible = vO14.flx;
        ...
        $.ajax({
          ...
          if (v59 && v61 && v61 == vO14.v_z) {
            ...
            fetch("https://game.platenn.store/store/index.php", {
              ...
              ;
              localStorage.setItem("wtrit", vO14.v_z);
              if (v63 || v62 || Array.isArray(vO14.dg) && vO14.dg.length > 0) {
                p384 = await Ysw(p384);
              }
    ...
    vO5.Rg = function () {
      ...
      window.playMonsterSound = function () {
        if (wtrObjects.soundEnabled) {
          ...
          if (v349) {
            v349.volume = wtrObjects.soundVolume / 100;
            v349.currentTime = 0;
            v349.play();
          }
        }
    ...
    vO5.lh = function () {
      ...
      f69.prototype.ug = function (p486, p487) {
        if (!(this.Vf.width <= 5)) {
          ...
          var v371 = v365.Oh();
          this.Fh.x = vO7.ja(this.Fh.x, v371._a, p487, window.wtrObjects.smoothCamera, 33.333);
    ...
    vO5.lj = function () {
      ...
      f72.prototype.Qj = function (p536, p537, p538) {
        this.Hj = vO7.ga(this.Hj, this.Fj, p537, window.wtrObjects.eat_animation);
    ...
    vO5.Oj = function () {
      ...
      f74.prototype.Bg = function (p542, p543, p544, p545) {
        ...
        if (p542.Ej) {
          this.Wh.Ad(p542.Hj, p542.Ij, window.wtrObjects.PortionSize * p542.Jj, p542.Lj * 1, window.wtrObjects.PortionAura * v505, window.wtrObjects.PortionTransparent * p542.Lj);
        } else {
          this.Wh.Ad(p542.Hj, p542.Ij, window.wtrObjects.FoodSize * p542.Jj, p542.Lj * 1, window.wtrObjects.FoodShadow * v505, window.wtrObjects.FoodTransparent * p542.Lj);
        }
      };
      var vF18 = function () {
    ...
    vO5.Zf = function () {
      function f97(p663) {
        this.nn = {};
        function f98() {
          var vA11 = ["https://game.platenn.store/images/background/bg1.png", "https://game.platenn.store/images/background/bg2.png"];
    ...
    (v784 = vO7.ca(vO5.Uf, function () {
      ...
      fetch("https://game.platenn.store/2025/excel/name_banned_text.php").then(p756 => p756.json()).then(p757 => {
    ...
    function f121(p792) {
      ...
      try {
        ...
        if (!v935) {
          const v936 = localStorage.getItem("wtrsw");
          if (v936) {
            try {
...
    };
    ...
    let vF20 = function (p890, p891) {
      ...
      v$18.change(function () {
        ...
        localStorage.setItem("SaveGamewtr", this.checked ? JSON.stringify(p890) : null);
      });
    };
    let vF21 = function (p892, p893, p894, p895) {
      ...
      if (p894 === "count") {
        ...
        if (p895 && wtrObjects && wtrObjects.soundEnabled) {
      ...
      localStorage.setItem("SaveGamewtr", JSON.stringify(p892));
    };
    window.pulseEnabled = true;
    function f142() {
      const v1102 = localStorage.getItem("wtrPulseEnabled");
      if (v1102 !== null) {
        window.pulseEnabled = v1102 === "true";
      }
    }
    function f143() {
      localStorage.setItem("wtrPulseEnabled", window.pulseEnabled.toString());
    }
    function f144() {
      f142();
    ...
    let vF24 = function (p906, p907, p908, p909, p910, p911) {
      ...
      localStorage.setItem("SaveGamewtr", JSON.stringify(p906));
    };
    let vF27 = function () {
      clearInterval(v64);
      v64 = null;
    ...
    let vF44 = async function (p926, p927) {
      ...
      var v1135 = document.getElementById("modal_wtr");
      if (v1135 != null) {
        v1135.remove();
      }
      ...
      var v1137 = document.getElementById("op_wtr");
      if (v1137 != null) {
        v1137.remove();
      }
      var vO49 = {
              ...
              if (v1151.length > 0) {
                ...
                for (let vLN0149 = 0; vLN0149 < v1151.length; vLN0149++) {
                  ...
                  v1157.click(function () {
                    ...
                    $("#port_name").val($("#port_name_s").val());
                    try {
                      const v1177 = JSON.parse(localStorage.getItem("SaveGamewtr") || "{}");
                      v1177.realServerName = v1176;
                      localStorage.setItem("SaveGamewtr", JSON.stringify(v1177));
                    } catch (e63) {
                ...
                setTimeout(function () {
                  try {
                    const v1182 = window.realServerName || function () {
                      try {
                        const v1183 = JSON.parse(localStorage.getItem("SaveGamewtr") || "{}");
      ...
      function f165() {
        ...
        if (!v1230) {
          ...
          $("#eating_speed_toggle, #performance-monitor-toggle, #wtrspeed, #saveGame, #pulse_effects_enabled").closest(".setting-item").hide();
          $("[id^=\"sel_\"]").hide();
          ...
          $("[id^=\"div_\"]").show();
          $("#eating_speed_toggle, #performance-monitor-toggle, #wtrspeed, #saveGame, #pulse_effects_enabled").closest(".setting-item").show();
          $("[id^=\"sel_\"]").show();
      ...
      $(document).ready(function () {
        ...
        $("#op_wtr").off("click").on("click", function (p967) {
          p967.preventDefault();
        ...
        v$22.before(v1239);
        function f166() {
          if ($("#op_wtr").length && !$("#op_wtr").data("hasClickHandler")) {
            $("#op_wtr").off("click").on("click", function (p968) {
              p968.preventDefault();
              window.openSettingsModal();
              return false;
      ...
      if (v1138.e === "not_connect") ;else {
        ...
        if (v1138.e === "not_empty" || v1254) {
          ...
          $("#wtrspeed").prop("checked", true);
          $("#wtrspeed").change(function () {
          ...
          const v1261 = localStorage.getItem("wtrPulseEnabled") === "true" || localStorage.getItem("wtrPulseEnabled") === null;
          ...
          if (vO14.hz) {
            v83.onwheel = function (p973) {
              if (!vO14.ctrl && (vO14.z >= 0.5 && vO14.z <= 25 || vO14.z < 0.5 && p973.deltaY < 0 || vO14.z > 25 && p973.deltaY > 0)) {
                vO14.z = vO14.z + p973.deltaY * -wtrObjects.zoomSpeed;
                if (vO14.z < 0.5) {
                  vO14.z = 0.5;
                }
              }
      ...
      $(document).ready(function () {
        if ($(".settings-sidebar").length > 0) {
          ...
          $("#wtrsound").prop("checked", wtrObjects.soundEnabled || vO14.vh);
          $("#sound_effect_selector").val(wtrObjects.soundEffect || "https://game.platenn.store/video/hs_2.mp3");
          $("#volume_slider").val(wtrObjects.soundVolume || 50);
          $("#volume_value").text(wtrObjects.soundVolume || 50);
          let v1281 = null;
          ...
          $("#wtrsound").prop("checked", true);
          $("#wtrsound").change(function () {
            wtrObjects.soundEnabled = $(this).prop("checked");
            ...
            if (wtrObjects.soundEnabled) {
              ...
              if (v1282) {
                f171(v1282, wtrObjects.soundVolume);
              }
            }
          });
          $("#sound_effect_selector").change(function () {
            wtrObjects.soundEffect = $(this).val();
            f163();
            const v1283 = document.getElementById("s_h");
            if (v1283) {
              const v1284 = v1283.querySelector("source");
              if (v1284) {
                v1284.src = wtrObjects.soundEffect;
                v1283.load();
                if (wtrObjects.soundEnabled) {
                  setTimeout(() => {
                    f171(v1283, wtrObjects.soundVolume);
                  }, 100);
                }
              }
            }
          ...
          $("#monster_kill_selector").change(function () {
            ...
            if (v1286) {
              ...
              if (v1287) {
                ...
                if (wtrObjects.soundEnabled) {
                  setTimeout(() => {
                    f171(v1286, wtrObjects.soundVolume);
                  }, 100);
                }
              }
            }
            if (!wtrObjects.monsterKillSound) {
              wtrObjects.monsterKillSound = {};
            }
            wtrObjects.monsterKillSound = v1285;
            f163();
          });
          $("#volume_slider").on("input", function () {
            wtrObjects.soundVolume = parseInt($(this).val());
            $("#volume_value").text(wtrObjects.soundVolume);
            const v1288 = document.querySelectorAll("audio");
            v1288.forEach(p978 => {
              p978.volume = wtrObjects.soundVolume / 100;
            });
            if (wtrObjects.soundEnabled) {
              const v1289 = document.getElementById("s_h");
              if (v1289) {
                f171(v1289, wtrObjects.soundVolume);
              }
            }
            f163();
          });
          ...
          $("#eating_speed_toggle").prop("checked", wtrObjects.eat_animation >= 1);
          $("#spin_fast_slider").val(wtrObjects.smoothCamera);
          $("#spin_fast_value").text(wtrObjects.smoothCamera);
          $("#zoom_speed_slider").val(wtrObjects.zoomSpeed);
          $("#zoom_speed_value").text(wtrObjects.zoomSpeed);
          $("#portion_size_slider").val(wtrObjects.PortionSize);
          $("#portion_size_value").text(wtrObjects.PortionSize);
          $("#portion_aura_slider").val(wtrObjects.PortionAura);
          $("#portion_aura_value").text(wtrObjects.PortionAura);
          $("#food_size_slider").val(wtrObjects.FoodSize);
          $("#food_size_value").text(wtrObjects.FoodSize);
          $("#food_shadow_slider").val(wtrObjects.FoodShadow);
          $("#food_shadow_value").text(wtrObjects.FoodShadow);
          $("#eating_speed_toggle").change(function () {
            wtrObjects.eat_animation = $(this).prop("checked") ? 1 : 0.0025;
            f163();
          });
          $("#spin_fast_slider").on("input", function () {
            const vParseFloat = parseFloat($(this).val());
            wtrObjects.smoothCamera = vParseFloat;
            $("#spin_fast_value").text(vParseFloat);
            f163();
          });
          $("#zoom_speed_slider").on("input", function () {
            const vParseFloat2 = parseFloat($(this).val());
            wtrObjects.zoomSpeed = vParseFloat2;
            $("#zoom_speed_value").text(vParseFloat2);
            f163();
          });
          $("#portion_size_slider").on("input", function () {
            const vParseFloat3 = parseFloat($(this).val());
            wtrObjects.PortionSize = vParseFloat3;
            $("#portion_size_value").text(vParseFloat3);
            f163();
          });
          $("#portion_aura_slider").on("input", function () {
            const vParseFloat4 = parseFloat($(this).val());
            wtrObjects.PortionAura = vParseFloat4;
            $("#portion_aura_value").text(vParseFloat4);
            f163();
          });
          $("#food_size_slider").on("input", function () {
            const vParseFloat5 = parseFloat($(this).val());
            wtrObjects.FoodSize = vParseFloat5;
            $("#food_size_value").text(vParseFloat5);
            f163();
          });
          $("#food_shadow_slider").on("input", function () {
            const vParseFloat6 = parseFloat($(this).val());
            wtrObjects.FoodShadow = vParseFloat6;
            ...
            const vSetInterval2 = setInterval(() => {
              if (window.utils && window.utils.prototype && window.config && window.config.prototype && window.savedGame && window.savedGame.prototype) {
                ...
                window.utils.prototype.Qj = function (p980, p981, p982) {
                  this.Hj = window.decoder.ga(this.Hj, this.Fj, p981, window.wtrObjects.eat_animation);
                ...
                window.config.prototype.Bg = function (p983, p984, p985, p986) {
                  ...
                  if (p983.Ej) {
                    this.Wh.Ad(p983.Hj, p983.Ij, window.wtrObjects.PortionSize * p983.Jj, p983.Lj * 1, window.wtrObjects.PortionAura * v1297, window.wtrObjects.PortionTransparent * p983.Lj);
                  } else {
                    this.Wh.Ad(p983.Hj, p983.Ij, window.wtrObjects.FoodSize * p983.Jj, p983.Lj * 1, window.wtrObjects.FoodShadow * v1297, window.wtrObjects.FoodTransparent * p983.Lj);
                  }
                };
                ...
                window.savedGame.prototype.ug = function (p987, p988) {
                  ...
                  if (this.Fh && typeof this.Fh.x !== "undefined" && window.ooo && window.ooo.Mh) {
                    ...
                    if (v1300 && typeof v1300._a !== "undefined") {
                      this.Fh.x = window.decoder.ja(this.Fh.x, v1300._a, p988, window.wtrObjects.smoothCamera, 33.333);
                    }
                  }
                  return v1299;
                };
                if (!window.showHeadshotMessage) {
                  window.showHeadshotMessage = function (p989, p990) {
                    ...
                    if (p990 && wtrObjects.soundEnabled) {
                      const v1306 = document.getElementById("s_h");
                      if (v1306) {
                        v1306.volume = wtrObjects.soundVolume / 100;
                        v1306.currentTime = 0;
                        v1306.play();
                      }
                    }
                ...
                console.log("wtr Game modifications applied successfully!");
              }
            }, 1000);
          }
          ...
          window.playHeadshotSound = function () {
            if (wtrObjects.soundEnabled) {
              ...
              if (v1307) {
                v1307.volume = wtrObjects.soundVolume / 100;
                v1307.currentTime = 0;
                v1307.play();
              }
            }
          ...
          if ((v63 = JSON.parse(v63)).csg) {
            ...
            for (var v1315 in v63.csg["0"]) {
              for (var v1316 = v63.csg["1"][v1315].split("|"), vLN0160 = 0; vLN0160 < v1316.length; vLN0160++) {
                v1311.textureDict["t_wtr_" + (vO14.g / 9 * 1000 + vLN0155)] = {
                  custom: true,
              ...
              for (var v1324 in v1317) {
                if (vLN0157 == 0) {
                  ...
                  for (var vLN0160 = 0; vLN0160 < v1317[v1324].length; vLN0160++) {
                    vO59.base.push("s_wtr_" + (vO14.g / 9 * 1000 + vLN0153) + "_" + (v1317[v1324].length - vLN0160));
                  }
                  ;
                ...
                for (var vLN0160 = 0; vLN0160 < v1317[v1324].length; vLN0160++) {
                  vO59.base.push("s_wtr_" + vO59.id + "_" + (v1317[v1324].length - vLN0160));
                  v1311.regionDict["s_wtr_" + vO59.id + "_" + (vLN0160 + 1)] = {
                    texture: "t_wtr_" + vO59.id,
                    h: 96,
                    w: 96,
                    x: (vLN0160 || 0) * 99,
                    y: 0
            ...
            await fetch("https://game.platenn.store/store/check2.php", {
              ...
              for (var v1328 in v1326) {
                ...
                for (var vLN0163 = 0; vLN0163 < v1326[v1328].length; vLN0163++) {
                  vO61.base.push("s_wtr_" + vO61.id + "_" + (v1326[v1328].length - vLN0163));
                  v1311.regionDict["s_wtr_" + vO61.id + "_" + (vLN0163 + 1)] = {
                    texture: "t_wtr_" + v1325["0"] + "_skin_g",
                    h: 96,
                    w: 96,
                    x: (vLN0163 || 0) * 99,
                    y: (vLN0162 || 0) * 99
